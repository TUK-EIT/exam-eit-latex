...
%\begin{titlepage}
    \begin{center}
        ...
        {\Large\bf\sc Exam \examID\\ in \\
        \examTitleLong \\}\vspace{1.0cm}
    \end{center}

    \underline{Permitted aids:}
    
    Slide-rule or {\bf {non}}programmable calculator, \textbf{maximally \allowedNumberOfSupportPages~handwritten DIN A4 sheet}, dictionaries ({\bf non-electronic}), writing and drawing material.
